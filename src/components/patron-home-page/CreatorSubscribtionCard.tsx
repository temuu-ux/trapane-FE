...
const CreatorSubscribtionCard = ({ data, creatorName }: { data: TierWithIdType, creatorName: string }) => {
  ...
  return (
    <div className="w-[340px]  bg-neutral-800  rounded-[12px] border-orange-50  flex flex-col gap-[12px]">
      ...
      <div className="p-[16px] flex flex-col gap-[12px]  ">
        ...
        <Link href={`/payment/${creatorName}`}>
        <button className=" h-[44px] bg-orange-50 rounded-lg text-neutral-700 text-base font-bold px-[16px]">
          Join
        </button>
        </Link>
...
export default CreatorSubscribtionCard;
